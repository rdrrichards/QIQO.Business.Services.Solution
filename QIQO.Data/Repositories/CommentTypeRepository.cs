...
namespace QIQO.Data.Repositories
{
    public class CommentTypeRepository : RepositoryBase<CommentTypeData>, ICommentTypeRepository
    {
        ...
        public override IEnumerable<CommentTypeData> GetAll()
        {
            ...
            {
                DataSet ds = entity_context.ExecuteProcedureAsDataSet("usp_comment_type_all");
        ...
        public IEnumerable<CommentTypeData> GetAllByCategory(string category)
        {
            ...
            List<SqlParameter> pcol = new List<SqlParameter>() { new SqlParameter("@comment_type_category", category) };
            using (entity_context)
            {
                DataSet ds = entity_context.ExecuteProcedureAsDataSet("usp_comment_type_get_cat", pcol);
        ...
        public override CommentTypeData GetByID(int comment_type_key)
        {
            ...
            List<SqlParameter> pcol = new List<SqlParameter>() { new SqlParameter("@comment_type_key", comment_type_key) };
            using (entity_context)
            {
                DataSet ds = entity_context.ExecuteProcedureAsDataSet("usp_comment_type_get", pcol);
        ...
        public override CommentTypeData GetByCode(string comment_type_code, string entity_code)
        {
            ...
            using (entity_context)
            {
                DataSet ds = entity_context.ExecuteProcedureAsDataSet("usp_comment_type_get_c", pcol);
        ...
        public override void DeleteByCode(string entity_code)
        {
            ...
            List<SqlParameter> pcol = new List<SqlParameter>() { new SqlParameter("@comment_type_code", entity_code) };
