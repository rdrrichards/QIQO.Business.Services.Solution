...
namespace QIQO.Data.Repositories
{
    public class ChartOfAccountsRepository : RepositoryBase<ChartOfAccountsData>, IChartOfAccountsRepository
    {
        ...
        public override IEnumerable<ChartOfAccountsData> GetAll()
        {
            ...
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_chart_of_accounts_all");
        ...
        public IEnumerable<ChartOfAccountsData> GetAll(CompanyData company)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_chart_of_accounts_all_by_company_key", pcol);
                Log.Info("ChartOfAccountsRepo ExecuteProcedureAsDataSet function call successful");
                return MapRows(ds);
            }
        }
        ...
        public IEnumerable<ChartOfAccountsData> GetAll(string company_code)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@company_code", company_code) };
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_chart_of_accounts_all_by_company_code", pcol);
                Log.Info("ChartOfAccountsRepo ExecuteProcedureAsDataSet function call successful");
                return MapRows(ds);
            }
        }
        ...
        public override ChartOfAccountsData GetByID(int chart_of_accounts_key)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@chart_of_accounts_key", chart_of_accounts_key) };
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_chart_of_accounts_get", pcol);
        ...
        public override ChartOfAccountsData GetByCode(string chart_of_accounts_code, string entity_code)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_chart_of_accounts_get_c", pcol);
        ...
        public override void DeleteByCode(string entity_code)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@chart_of_accounts_code", entity_code) };
