...
namespace QIQO.Data.Repositories
{
    public class EntityTypeRepository : RepositoryBase<EntityTypeData>, IEntityTypeRepository
    {
        ...
        public override IEnumerable<EntityTypeData> GetAll()
        {
            ...
            {
                DataSet ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_type_all");
        ...
        public override EntityTypeData GetByID(int entity_type_key)
        {
            ...
            List<SqlParameter> pcol = new List<SqlParameter>() { new SqlParameter("@entity_type_key", entity_type_key) };
            using (entity_context)
            {
                DataSet ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_type_get", pcol);
        ...
        public override EntityTypeData GetByCode(string entity_type_code, string entity_code)
        {
            ...
            using (entity_context)
            {
                DataSet ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_type_get_c", pcol);
        ...
        public override void DeleteByCode(string entity_code)
        {
            ...
            List<SqlParameter> pcol = new List<SqlParameter>() { new SqlParameter("@entity_type_code", entity_code) };
