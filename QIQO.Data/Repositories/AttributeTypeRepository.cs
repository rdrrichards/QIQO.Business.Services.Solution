...
namespace QIQO.Data.Repositories
{
    public class AttributeTypeRepository : RepositoryBase<AttributeTypeData>, IAttributeTypeRepository
    {
        ...
        public override IEnumerable<AttributeTypeData> GetAll()
        {
            ...
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_attribute_type_all");
        ...
        public IEnumerable<AttributeTypeData> GetAllByCategory(string category)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@attribute_type_category", category) };
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_attribute_type_get_cat", pcol);
        ...
        public override AttributeTypeData GetByID(int attribute_type_key)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@attribute_type_key", attribute_type_key) };
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_attribute_type_get", pcol);
        ...
        public override AttributeTypeData GetByCode(string attribute_type_code, string entity_code)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_attribute_type_get_c", pcol);
        ...
        public override void DeleteByCode(string entity_code)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@attribute_type_code", entity_code) };
