...
namespace QIQO.Data.Repositories
{
    public class EntityPersonRepository : RepositoryBase<EntityPersonData>, IEntityPersonRepository
    {
        ...
        public override IEnumerable<EntityPersonData> GetAll()
        {
            ...
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_person_all");
        ...
        public IEnumerable<EntityPersonData> GetAll(CompanyData company)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_person_by_company", pcol);
        ...
        public IEnumerable<EntityPersonData> GetAll(AccountData account)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_person_by_account", pcol);
                Log.Info("Made it passed ExecuteProcedureAsDataSet (usp_entity_person_by_company) function!");
                return MapRows(ds);
            }
        }
        ...
        public override EntityPersonData GetByID(int entity_person_key)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@entity_person_key", entity_person_key) };
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_person_get", pcol);
        ...
        public override EntityPersonData GetByCode(string entity_person_code, string entity_code)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_person_get_c", pcol);
        ...
        public EntityPersonData GetByPersonID(int person_key, int entity_type_key)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_person_get_emp_rel", pcol);
        ...
        public IEnumerable<EntityPersonData> GetAllReps(CompanyData company, int rep_type)
        {
            ...
            using (entity_context)
            {
                var ds = entity_context.ExecuteProcedureAsDataSet("usp_entity_person_all_by_company_reponly", pcol);
        ...
        public override void DeleteByCode(string entity_code)
        {
            ...
            var pcol = new List<SqlParameter>() { new SqlParameter("@entity_person_code", entity_code) };
